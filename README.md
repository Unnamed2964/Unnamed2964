...
"Uma" is the result of replacing the initial letter of "Ama" to align with "Unnamed2964". "Umamichi" and "Umaichi" are used interchangeably, both are correct. However, it's worth noting that on any platform, there may only be a single account with any one of them as username or nickname controlled by me. No guarantee that other accounts with these names are controlled by me.
